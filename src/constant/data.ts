export const MusicalInstrumentData = {
  0: ["Acoustic Grand Piano", "大钢琴（声学钢琴）"], // 钢琴类
  ...
  24: ["Acoustic Guitar (nylon)", "尼龙弦吉他"], //  吉他
  ...
  48: ["String Ensemble 1", "弦乐合奏音色1"], //  合唱、合奏
  ...
  80: ["Lead 1 (square)", "合成主音1（方波）"], //  合成主音
  ...
  88: ["Pad 1 (new age)", "合成音色1（新世纪）"], //  合成音色
  ...
  120: ["Guitar Fret Noise", "吉他换把杂音"], // 声音效果
